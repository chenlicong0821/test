...
public class CatchMultiException {
    ...
    private static void catchMultiOld() {
        try {
            ...
            System.out.println("old ClassNotFoundException");
            e.printStackTrace();
        } catch (IOException e) {
            System.out.println("old IOException");
            e.printStackTrace();
        }
    }
...
//        }
    ...
    private static void catchMultiNew() {
        try {
            ...
            System.out.println("new ClassNotFoundException or IOException");
            e.printStackTrace();
        }
    }

    private static void throwMultiException(int i) throws ClassNotFoundException, IOException {
    // private static void throwMultiException(int i) throws Exception {
        switch (i) {
            case 1:
